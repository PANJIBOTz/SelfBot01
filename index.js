...
break
    ...
    case 'reverse':
       ...
       case 'sc': 
       case 'src':
              xdev.sendMessage(from, `Bot ini menggunakan sc dari youtube https://youtu.be/mYNTKS`, text, {quoted : dev, detecLinks : true})
              break
...
await xdev.sendMessage(from, gbuttonan, MessageType.buttonsMessage, {                         
 ...
 gbuttonan = {
        ...
        if(isExtream) return
        sendKontak(from, "6281916892383", "Kadek Panji", "Sibuk");
...
xdev.sendMessage(from, `
*INSTAGRAM*
https://www.instagram.com/kadekpanjiii_/?utm_medium=copy_link`,
